...
async def cmd_help(message: Message) -> None:
    await message.answer(
        "⚽ <b>Битва прогнозов ЧМ-2026</b>\n"
        "\n"
        "<b>Как это работает:</b>\n"
        "Ставишь прогноз на счёт матча <i>до начала</i>. После игры получаешь очки:\n"
        "🎯 Точный счёт → <b>3 очка</b>\n"
        "✅ Угадал исход (победа/ничья) → <b>1 очко</b>\n"
        "❌ Не угадал → <b>0 очков</b>\n"
        "\n"
        "<b>Удвоение</b> (8 штук на весь турнир):\n"
        "Помечаешь прогноз «×2» — очки удваиваются (3→6 или 1→2).\n"
        "Но если промахнулся — штраф <b>−1 очко</b>. Трать с умом.\n"
        "\n"
        "<b>Плей-офф:</b>\n"
        "Если прогноз ничья — можно дополнительно указать кто пройдёт дальше и как (ОТ или ПЕН).\n"
        "Угадал победителя → +1, угадал победителя <i>и</i> способ → +2.\n"
        "\n"
        "<b>Команды:</b>\n"
        "/matches — матчи и ввод прогнозов\n"
        "/me — твоя статистика и место в рейтинге\n"
